...
import (
	...
	"github.com/ifabianto/bookings/internal/config"
	"github.com/ifabianto/bookings/internal/driver"
	"github.com/ifabianto/bookings/internal/forms"
	"github.com/ifabianto/bookings/internal/helpers"
	"github.com/ifabianto/bookings/internal/models"
	"github.com/ifabianto/bookings/internal/render"
	"github.com/ifabianto/bookings/internal/repository"
	"github.com/ifabianto/bookings/internal/repository/dbrepo"
)
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	rooms, err := m.DB.SearchaAvailabilityFromAllRooms(startDate, endDate)
	if err != nil {
		helpers.ServerError(w, err)
		return
	}
...
func (m *Repository) AvailabilityJSON(w http.ResponseWriter, r *http.Request) {
	...
	available, err := m.DB.SearchAvailaibilityByDatesByRoomID(startDate, endDate, roomID)
	if err != nil {
		resp := jsonResponse{
			OK:      false,
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	//ParseForm is a go built-in function
	err := r.ParseForm()
	if err != nil {
	...
	//passing the reservation data to reservation summary page
	m.App.Session.Put(r.Context(), "reservation", reservation)
...
func (m *Repository) Logout(w http.ResponseWriter, r *http.Request) {
	...
	//renew session token (good practice)
	_ = m.App.Session.RenewToken(r.Context())
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	lastOfMonth := firstOfMonth.AddDate(0, 1, -1) //get last day of the month
...
func (m *Repository) AdminProcessReservation(w http.ResponseWriter, r *http.Request) {
	...
	m.App.Session.Put(r.Context(), "flash", "Reservation marked as procesed")
